...
description: "Extracts and documents technical learnings from conversations, or reviews/summarizes learnings from past days. Use for: capturing key concepts after technical discussions, documenting design patterns, saving notes about tools/commands, or reviewing learning progress over time. Supports two modes: Capture Mode (save current session learnings) and Review Mode (summarize past N days)."
model: sonnet
color: green
---
